class Employee:
    raise_amount=1.04
    #anything enclosed with double underscores is called a 
    #dunder methodor a special method
    
    
    def __init__(self,first,last,pay):#this init method is a dunder method or a magic method 
        self.first=first
        self.last=last
        self.pay=pay
